...
public class MultiViewTypeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean potrate;


    // private String[] VideoID = {"P3mAtvs5Elc", "nCgQDjiotG0", "P3mAtvs5Elc"};


    public MultiViewTypeAdapter(List<NewsResponse.News> newsResponseList, Context context, Fragment fragment, boolean potrate) {
                ...
                case "image":
                    ...
                    ((ImageTypeViewHolder) holder).overflow.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            AngelPitchUtil.ShowDialog(mContext, object.getNews_id(), "image", object.getSource_link());
                        }
                    });
