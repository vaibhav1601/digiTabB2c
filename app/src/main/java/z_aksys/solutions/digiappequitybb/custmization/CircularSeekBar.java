package z_aksys.solutions.digiappequitybb.custmization;
...
public class CircularSeekBar extends View {
    ...
    // Default values
    protected static final float DEFAULT_CIRCLE_X_RADIUS = 50f;
    protected static final float DEFAULT_CIRCLE_Y_RADIUS = 50f;
    ...
    protected static final boolean DEFAULT_LOCK_DISABLE = true;
    /**
    ...
    protected void initAttributes(TypedArray attrArray) {
        ...
        lockEnabled = attrArray.getBoolean(R.styleable.CircularSeekBar_lock_disable, DEFAULT_LOCK_DISABLE);
