...
public class PitchData {
    ...
    private PitchData() {
        ...
        pitchSectionalSlide1.isSectionalHeader= true;
        ...
        pitchSectionalSlide1.title.put(LANG_ENG, "Why do investors choose Equity?");
        pitchSectionalSlide1.title.put(LANG_HINDI, "Why do investors choose Equity?");
        pitchSectionalSlide1.title.put(LANG_GUJRATI, "Why do investors choose Equity?");
        pitchSectionalSlide1.title.put(LANG_TAMIL, "Why do investors choose Equity?");
        pitchSectionalSlide1.title.put(LANG_BENGALI, "Why do investors choose Equity?");
        pitchSectionalSlide1.title.put(LANG_KANNADA, "Why do investors choose Equity?");
        ...
        pitchSlide1.path = "file:///android_asset/slides/lower-investment-than-other-channels.html";
        ...
        bundle.putString("slide_url", "file:///android_asset/slides/highest-returns-compared-to-other-investments.html");
        ...
        pitchSlide3.path = "file:///android_asset/slides/earn-more-than-just-compound-interest.html";
        ...
        pitchSlide4.path="file:///android_asset/slides/equity-offers-high-liquidity.html";
        ...
        pitchSectionalSlide2.isSectionalHeader= true;
        pitchSectionalSlide2.slideThumbnailPath="slides/thumbnails/section2.png";
        pitchSectionalSlide2.path = "file:///android_asset/slides/section-2.html";
        pitchSectionalSlide2.title.put(LANG_ENG, "Why do investors choose Angel Broking?");
        pitchSectionalSlide2.title.put(LANG_HINDI, "Why do investors choose Angel Broking?");
        pitchSectionalSlide2.title.put(LANG_GUJRATI, "Why do investors choose Angel Broking?");
        pitchSectionalSlide2.title.put(LANG_TAMIL, "Why do investors choose Angel Broking?");
        pitchSectionalSlide2.title.put(LANG_BENGALI, "Why do investors choose Angel Broking?");
        pitchSectionalSlide2.title.put(LANG_KANNADA, "Why do investors choose Angel Broking?");
        ...
        pitchSlide5.path = "file:///android_asset/slides/largest-stock-broking-house-in-india.html";
        ...
        bundle1.putString("slide_url", "file:///android_asset/slides/recommendations-for-winning-portfolio.html");
        ...
        pitchSlide7.path = "file:///android_asset/slides/single-account-for-investing-in-multiple-channels.html";
        ...
        bundle2.putString("slide_url", "file:///android_asset/slides/advance-and-user-friendly-trading-platforms.html");
        ...
        pitchSlide9.path = "file:///android_asset/slides/awards-and-recognitions.html";
        ...
        pitchSectionalSlide3.isSectionalHeader= true;
        pitchSectionalSlide3.slideThumbnailPath="slides/thumbnails/section3.png";
        pitchSectionalSlide3.path = "file:///android_asset/slides/section-3.html";
        pitchSectionalSlide3.title.put(LANG_ENG, "What is growth oppourtunity for Channel Partners?");
        pitchSectionalSlide3.title.put(LANG_HINDI, "What is growth oppourtunity for Channel Partners?");
        pitchSectionalSlide3.title.put(LANG_GUJRATI, "What is growth oppourtunity for Channel Partners?");
        pitchSectionalSlide3.title.put(LANG_TAMIL, "What is growth oppourtunity for Channel Partners?");
        pitchSectionalSlide3.title.put(LANG_BENGALI, "What is growth oppourtunity for Channel Partners?");
        pitchSectionalSlide3.title.put(LANG_KANNADA, "What is growth oppourtunity for Channel Partners?");
        ...
        pitchSlide10.path = "file:///android_asset/slides/per-capita-income-to-touch-$5-lakh-by-2030.html";
        ...
        pitchSlide11.path = "file:///android_asset/slides/investment-on-equity-is-on-rise.html";
        ...
        pitchSlide12.path = "file:///android_asset/slides/growing-need-for-channel-partners.html";
        ...
        pitchSectionalSlide4.isSectionalHeader= true;
        pitchSectionalSlide4.slideThumbnailPath="slides/thumbnails/section4.png";
        pitchSectionalSlide4.path = "file:///android_asset/slides/section-4.html";
        pitchSectionalSlide4.title.put(LANG_ENG, "Why become a Channel Partner with Angel Broking?");
        pitchSectionalSlide4.title.put(LANG_HINDI, "Why become a Channel Partner with Angel Broking?");
        pitchSectionalSlide4.title.put(LANG_GUJRATI, "Why become a Channel Partner with Angel Broking?");
        pitchSectionalSlide4.title.put(LANG_TAMIL, "Why become a Channel Partner with Angel Broking?");
        pitchSectionalSlide4.title.put(LANG_BENGALI, "Why become a Channel Partner with Angel Broking?");
        pitchSectionalSlide4.title.put(LANG_KANNADA, "Why become a Channel Partner with Angel Broking?");
        ...
        pitchSlide13.path = "file:///android_asset/slides/largest-channel-partner-network.html";
        ...
        //pitchSlide14.path = "file:///android_asset/slides/11-END-TO-END-SOLUTIONS.html";
        ...
        pitchSlide15.path = "file:///android_asset/slides/bee-nxt-best-in-class-mf-servicing-platform-for-you.html";
        ...
        pitchSectionalSlide5.isSectionalHeader= true;
        pitchSectionalSlide5.slideThumbnailPath="slides/thumbnails/section5.png";
        pitchSectionalSlide5.path = "file:///android_asset/slides/section-5.html";
        pitchSectionalSlide5.title.put(LANG_ENG, "What is Angle Broking's business model?");
        pitchSectionalSlide5.title.put(LANG_HINDI, "What is Angle Broking's business model?");
        pitchSectionalSlide5.title.put(LANG_GUJRATI, "What is Angle Broking's business model?");
        pitchSectionalSlide5.title.put(LANG_TAMIL, "What is Angle Broking's business model?");
        pitchSectionalSlide5.title.put(LANG_BENGALI, "What is Angle Broking's business model?");
        pitchSectionalSlide5.title.put(LANG_KANNADA, "What is Angle Broking's business model?");
        ...
        pitchSlide16.path = "file:///android_asset/slides/13-ONE-APP-MULTIPLE-FEATURES.html";
        ...
        pitchSectionalSlide6.isSectionalHeader= true;
        pitchSectionalSlide6.slideThumbnailPath="slides/thumbnails/section6.png";
        pitchSectionalSlide6.path = "file:///android_asset/slides/section-6.html";
        pitchSectionalSlide6.title.put(LANG_ENG, "What is Angle Broking's business model?");
        pitchSectionalSlide6.title.put(LANG_HINDI, "What is Angle Broking's business model?");
        pitchSectionalSlide6.title.put(LANG_GUJRATI, "What is Angle Broking's business model?");
        pitchSectionalSlide6.title.put(LANG_TAMIL, "What is Angle Broking's business model?");
        pitchSectionalSlide6.title.put(LANG_BENGALI, "What is Angle Broking's business model?");
        pitchSectionalSlide6.title.put(LANG_KANNADA, "What is Angle Broking's business model?");
